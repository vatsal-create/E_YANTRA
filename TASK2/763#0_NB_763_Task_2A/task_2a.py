...
def get_vision_sensor_image():
    ...
    return_code, vision_handle = sim.simxGetObjectHandle(client_id, 'Vision_sensor', sim.simx_opmode_blocking)
    return_code, image_resolution, vision_sensor_image = sim.simxGetVisionSensorImage(client_id, vision_handle, 0, sim.simx_opmode_streaming)
    sim.simxGetPingTime(client_id)
    return_code, image_resolution, vision_sensor_image = sim.simxGetVisionSensorImage(client_id, vision_handle, 0, sim.simx_opmode_buffer)
