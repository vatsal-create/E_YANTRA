...
prev_angle_x, prev_angle_y = 3, 3
PID_P_x, PID_P_y, PID_I_x, PID_I_y, PID_D_x, PID_D_y = 0, 0, 0, 0, 0, 0
kp_x, ki_x, kd_x = 50, 0.1, 65  # 16, -0.3, 28  # 14, 0.5, 6
kp_y, ki_y, kd_y = 50, 0.1, 65  # 16, 0.3, 28  # 14, 0.1, 5
...
def control_logic(center_x, center_y):
    ...
    offset_x = velocity[0] * 540
    offset_y = velocity[1] * 540

    center_x += offset_x
    center_y += offset_y
    error_x = setpoint[1] - center_x
    error_y = setpoint[0] - center_y
    ...
    '''angle_x = prev_angle_x+(dt/1)*(prev_angle_x-angle_x)
    angle_y = prev_angle_y+(dt/1)*(prev_angle_y-angle_y)
    print(angle_x,angle_y,(dt/1))
    print(prev_angle_x-angle_x)'''
